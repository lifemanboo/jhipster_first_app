...
@RestController
@RequestMapping("/api/jhipsterfirst-kafka")
public class JhipsterfirstKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterfirstKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterfirstKafkaResource(KafkaProperties kafkaProperties) {
