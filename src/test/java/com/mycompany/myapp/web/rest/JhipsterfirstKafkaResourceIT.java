...
class JhipsterfirstKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterfirstKafkaResource kafkaResource = new JhipsterfirstKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipsterfirst-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipsterfirst-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
